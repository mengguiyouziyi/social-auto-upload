        ...
        <div class="sidebar">
          ...
          >
            ...
            <el-sub-menu index="/ai-features">
              ...
              <el-menu-item index="/content-analysis">
              ...
              <el-menu-item index="/performance-optimization">
              ...
              <el-menu-item index="/api-marketplace">
                <el-icon><Connection /></el-icon>
                <span>API市场</span>
              </el-menu-item>
              <el-menu-item index="/ai-content-generator">
                <el-icon><MagicStick /></el-icon>
                <span>AI内容生成器</span>
              </el-menu-item>
            </el-sub-menu>
...
import {
  HomeFilled, User, Picture, Upload, Fold, MagicStick, DataAnalysis, OfficeBuilding, UserFilled, Lightning, Monitor, Connection, Timer
